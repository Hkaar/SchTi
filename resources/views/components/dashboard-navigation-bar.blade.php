  ...
  <nav class="w-full mx-auto px-6 sm:flex sm:items-center sm:justify-between">
    <div class="flex items-center justify-between">
      <span class="flex gap-3 items-center">
        <button type="button" class="btn border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-white dark:hover:bg-white/10 p-2"
    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
      <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
        ...
        <a class="font-medium text-red-600 hover:text-gray-400 dark:text-red-400 dark:hover:text-neutral-500 flex items-center gap-1" href="#">
